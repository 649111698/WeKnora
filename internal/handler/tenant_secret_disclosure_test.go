...
func (s *stubTenantService) SetBrandingConfig(context.Context, uint64, *types.BrandingConfig) error {
	return nil
}
func (s *stubTenantService) SetDefaultMemberAgentIDs(context.Context, uint64, types.AgentIDList) error {
	return nil
}
