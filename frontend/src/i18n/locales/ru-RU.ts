    ...
    globalSettings: {
      ...
      keyDescriptions: {
        ...
        auth: {
          ...
          watermark_enabled: 'При включении на все страницы (вход, чат, настройки; ПК и мобильные) накладывается неинтерактивный текстовый водяной знак для защиты от утечек скриншотов. Применяется для новых сессий без перезапуска.',
          watermark_text: 'Текст водяного знака. Поддерживает плейсхолдер {username}, заменяемый именем вошедшего пользователя; при пустом значении используется {username}.'
        }
      },
      keyLabels: {
        model: {
        ...
        tenant: {
          ...
          wecom: {
            ...
            domain_verify_text: 'WeCom SSO · текст проверки домена'
          },
          feishu: {
        ...
        auth: {
          ...
          watermark_enabled: 'Водяной знак на всём сайте',
      ...
      sections: {
        ...
        watermark: {
          tab: 'Водяной знак {count}',
          title: 'Водяной знак',
          description: 'Наложение водяного знака для отслеживания утечек на все страницы. Текст поддерживает плейсхолдер {username}; применяется к новым сессиям сразу, без перезапуска.'
        },
        ssoWecom: {
          tab: 'WeCom SSO {count}',
          title: 'SSO WeCom',
          description: 'Учётные данные самописного приложения WeCom (CorpID / Secret / AgentId). После настройки на странице входа появляется кнопка WeCom; изменения применяются сразу, без перезапуска.'
        },
        ssoFeishu: {
          tab: 'Feishu SSO {count}',
          title: 'SSO Feishu',
          description: 'Учётные данные самописного приложения Feishu (App ID / App Secret). После настройки на странице входа появляется кнопка Feishu; изменения применяются сразу, без перезапуска.'
        },
        security: {
