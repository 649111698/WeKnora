export default {
  tenantSSO: {
      ...
      loginDomain: {
        ...
        description: 'Привяжите выделенный домен к этому пространству (необязательно). Посетители с этого домена (или по ссылке входа с параметром ?t=) автоматически получают SSO и водяной знак этого пространства. Домены уникальны для каждого пространства.',
        label: 'Домен входа',
