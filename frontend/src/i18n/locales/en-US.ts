export default {
  ...
  tenantSSO: {
      ...
      kingdee: {
        title: 'Kingdee Cosmic SSO',
        description: 'Use the Kingdee Cosmic portal as the identity source (Cosmic V6.0.015+, OAuth2.0 authorization code). Register the system code under "System Service Cloud → OpenAPI → Third-party App" on the Cosmic side and authorize the authen/getUserInfo API; staff enter via the Cosmic portal menu and guest accounts are provisioned on first login.',
        baseUrl: 'Cosmic site base URL',
        baseUrlPlaceholder: 'e.g. https://kde.erp.com (no trailing slash)',
        appClientId: 'System code (app_client_id)',
        appClientIdPlaceholder: 'System code from Cosmic third-party app',
        appSecret: 'appSecret',
        appSecretPlaceholder: 'Custom appSecret from Cosmic credentials',
        appSecretHint: 'Required for standalone deployments: exchanged together with the two fields below for an access token before calling the user API.',
        proxyUsername: 'Proxy username (username)',
        proxyUsernamePlaceholder: 'username from the Cosmic "Get Token Example" dialog',
        accountId: 'Data center id (accountId)',
        accountIdPlaceholder: 'accountId from the Cosmic "Get Token Example" dialog',
        tokenModeHint: 'All three fields above (appSecret / username / accountId) are shown in the Cosmic third-party app "Get Token Example". Standalone deployments must configure them; if any is missing, the system falls back to direct code mode, which most private deployments reject.',
  ...
  knowledgeBase: {
    ...
    moveTargetSection: 'Select a target knowledge base',
    batchMoveSubtitle: 'Move the {count} selected documents to another knowledge base (only finished parsing documents are moved)',
    batchMoveNoCompleted: 'None of the selected documents have finished parsing; nothing to move',
    batchMoveSkippedNotCompleted: 'Skipped {count} documents that have not finished parsing',
  ...
  auth: {
    ...
    kingdeeLogin: 'Sign in with Kingdee Cosmic',
    kingdeeLoginFailed: 'Failed to redirect to Kingdee Cosmic',
    username: 'Username',
    email: 'Email',
    password: 'Password',
    confirmPassword: 'Confirm Password',
  ...
  tenantMember: {
    ...
    directCreate: {
      ...
      dialogTitle: 'Create member (new account)',
      nameLabel: 'Name',
      namePlaceholder: 'Enter the real name',
      nameRequired: 'Name must be 2-50 characters',
      usernameLabel: 'Username',
      usernamePlaceholder: '2-50 characters',
      usernameRequired: 'Username must be 2-50 characters',
      passwordLabel: 'Initial password',
      passwordPlaceholder: '8-32 chars with letters and numbers',
      passwordPolicy: 'Password must be 8-32 characters with at least one letter and one number',
      submit: 'Create',
      success: 'Member created and added to the workspace',
    ...
    editName: {
      ...
      required: 'Name must be 2-50 characters',
      saved: 'Name updated',
      saveFailed: 'Failed to update name, please retry',
    },
